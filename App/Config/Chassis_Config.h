...
#define ELEVATOR_FEEDFORWARD_FOR_LB_RF 1.27f
#define ELEVATOR_FEEDFORWARD_FOR_LF_RB -1.27f
...
#define ELEVATOR_LF_3rd_ACTIVATED_POS (ELEVATOR_LF_1st_ACTIVATED_POS*0.65f)
