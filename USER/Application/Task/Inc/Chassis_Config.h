...
#define ELEVATOR_LF_3rd_ACTIVATED_POS (ELEVATOR_LF_1st_ACTIVATED_POS*0.5f)
#define ELEVATOR_LB_3rd_ACTIVATED_POS (ELEVATOR_LB_1st_ACTIVATED_POS*0.5f)
#define ELEVATOR_RB_3rd_ACTIVATED_POS (ELEVATOR_RB_1st_ACTIVATED_POS*0.5f)
#define ELEVATOR_RF_3rd_ACTIVATED_POS (ELEVATOR_RF_1st_ACTIVATED_POS*0.5f)
