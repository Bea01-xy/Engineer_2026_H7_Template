...
#define ELEVATOR_LF_2nd_ACTIVATED_POS (ELEVATOR_LF_1st_ACTIVATED_POS*0.4f)
#define ELEVATOR_LB_2nd_ACTIVATED_POS (ELEVATOR_LB_1st_ACTIVATED_POS*0.4f)
#define ELEVATOR_RB_2nd_ACTIVATED_POS (ELEVATOR_RB_1st_ACTIVATED_POS*0.4f)
#define ELEVATOR_RF_2nd_ACTIVATED_POS (ELEVATOR_RF_1st_ACTIVATED_POS*0.4f)
